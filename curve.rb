...
=begin
M is the prime specifying the base field.

A and B are the coefficients of the equation y^2 = x^3 + A*x + B mod M defining the elliptic curve.
...
module Curve
	...
	#attr_reader :x, :y, :m, :a, :b

	M = 0xAADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3
